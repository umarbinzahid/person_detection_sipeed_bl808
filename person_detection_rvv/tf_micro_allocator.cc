...
public:
    ...
    const AllocationInfo *Finish() const
    {
        return info_;
    }
    ...
    *result = {};
    ...
    if (src_quantization && src_quantization->scale() &&
        ...
        TfLiteAffineQuantization *quantization =
            allocate_temp ? reinterpret_cast<TfLiteAffineQuantization *>(
        ...
        quantization->zero_point =
            allocate_temp ? reinterpret_cast<TfLiteIntArray *>(allocator->AllocateTemp(
